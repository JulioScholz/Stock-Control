...
public class StockControll {
    ...
    private void handlerButtonAction_pesquisar(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene6.fxml"));
    ...
    private void handlerButtonAction_pesquisar2(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene6_1.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_relatorio(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene3.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_voltar(ActionEvent event) throws IOException {
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene2.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_voltar2(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene8.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_cadastrarFunc(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene4.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_cadastrarObj(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene7.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void handlerButtonAction_logout(ActionEvent event) throws IOException {
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene1.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public int login(TextField userName, TextField password) throws SQLException {
        if(userName.getText().trim().isEmpty())
            ...
            return NOPASSWORD;
        else if(user_Manager.authenticate(userName.getText(), password.getText()) == 5)
            return RIGHTUSER;
        else if(user_Manager.authenticate(userName.getText(), password.getText()) == 4)
            return RIGHTADMNIN;
    ...
    public void showLoginScreen(ActionEvent event) throws IOException, SQLException {
        ...
        if(retorno == NOUSERNAME)
            ...
            noUserWarning.setText("Usuário ou senha incorretos");
    ...
    public void showUpdateStockScreen(ActionEvent event) throws IOException {
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene5.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public void showUpdateStockScreen2(ActionEvent event)throws IOException {
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("../../../Desktop/Stock-Control/src/sample/scene5_1.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
